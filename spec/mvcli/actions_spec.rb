...
describe "MVCLI::Actions" do
  ...
  Given(:renderer) { double(:Renderer, :render => true) }
  ...
  context "when the class exists" do
    ...
    When {actions['foo#bar'].call(double(:Command, :output => output), {})}
